...
- Freemium: базовый просмотр данных бесплатно, пакетная заявка и автоматические сценарии — премиум
- Партнёрские программы с банками за выданные рефинансирования
- Дополнительная маржа за счёт привлечения клиентов других банков в собственный кредитный портфель
- White-label лицензирование iframe-виджета для финтех-сервисов
- Платные API-запросы для получения персональных предложений по рефинансированию (модель pay-per-use)
