export const getMockLoanDetails = () => [
  ...
  {
    // Ещё один внешний кредит другого банка под 15.9%
    id: 'loan-external-2',
    agreement_id: 'loan-external-2',
    source: 'external',
    product_type: 'loan',
    amount: 300000,
    currency: 'RUB',
    ...
    origin_bank: 'abank',
    account_number: '40817810099910005678',
    balance: [
      {
        amount: 300000,
        currency: 'RUB',
